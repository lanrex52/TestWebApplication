...
namespace Microsoft.Store.PartnerCenter.Storefront.Controllers
{
    ...
    public class TemplateController : Controller
    {
        ...
        public async Task<ActionResult> Home()
        {
            ...
            ViewBag.IsPortalAdmin = principal.IsPortalAdmin ? "true" : "false";
       ...
       // [Filters.Mvc.PortalAuthorize(UserRole = UserRole.None)]
        ...
        /// <summary>
        /// Serves the HTML template for the customer details presenter.
        /// </summary>
        /// <returns>The HTML template for the customer details presenter.</returns>
        [HttpGet]
